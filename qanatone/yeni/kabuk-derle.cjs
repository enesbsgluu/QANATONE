...
const GIRISLER = { 'kabuk.js': 'efekt.js', 'pano.js': 'pano.js', 'sizinti.js': 'sizinti.js', 'tup.js': 'tup.js', 'nav.js': 'nav.js' };
...
function derle() {
  ...
  const { PRIO, FIX, AD, DURUM_AD, DURUM_MESAJ, SEBEP, HUKUM, TARAMA } = mod.exports;
  ...
  for (const dil of ['tr', 'en']) {
    ...
    out[`tespit-fix.${dil}.json`] = Buffer.from(JSON.stringify({
      ...
      durum: DURUM_MESAJ[dil], sebep: SEBEP[dil], hukum: HUKUM[dil], tarama: TARAMA[dil],
    }));
  }
  return out;
}
